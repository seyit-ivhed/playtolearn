...
export const ShipStatsDisplay: React.FC<ShipStatsDisplayProps> = ({ stats, className = '' }) => {
    ...
    return (
        <div className={`${styles.container} ${className}`}>
            <h3 className={styles.title}>Ship Status</h3>
                ...
                <div className={styles.numericStats}>
                    <div className={styles.numericStat}>
                        ...
                        <div className={styles.numericStatContent}>
                            <span className={styles.numericLabel}>Attack</span>
                    ...
                    <div className={styles.numericStat}>
                        <span className={styles.statIcon}>🛡️</span>
                        <div className={styles.numericStatContent}>
                            <span className={styles.numericLabel}>Defense</span>
                    ...
                    <div className={styles.numericStat}>
                        <span className={styles.statIcon}>⚡</span>
                        <div className={styles.numericStatContent}>
                            <span className={styles.numericLabel}>Speed</span>
