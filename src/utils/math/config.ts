...
export const CONFIG: MathEngineConfig = {
    level1: {
        ...
        subtraction: { enabled: true, left: { min: 2, max: 10 }, right: { min: 1, max: 5 } },
    ...
    level2: {
        ...
        subtraction: { enabled: true, left: { min: 5, max: 20 }, right: { min: 1, max: 10 } },
        multiplication: { enabled: true, left: { min: 1, max: 10 }, right: { min: 2, max: 2 } }, // Intro to doubling
    },
    level3: {
        addition: { enabled: true, left: { min: 10, max: 50 }, right: { min: 10, max: 50 } },
        subtraction: { enabled: true, left: { min: 20, max: 100 }, right: { min: 1, max: 50 } },
        multiplication: { enabled: true, left: { min: 1, max: 10 }, right: { min: 2, max: 5 } }, // x2, x3, x4, x5
    },
};
