...
describe('Player Actions Slice', () => {
    ...
    describe('performAction', () => {
        it('should deal damage for standard attack', () => {
            const warrior = { id: 'u1', templateId: 'warrior_id', name: 'Warrior', hasActed: false, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, currentShield: 0, currentSpirit: 0, maxSpirit: 100, spiritGain: 10, damage: 10 };
    ...
    describe('resolveSpecialAttack', () => {
        it('should deal single target damage', () => {
            const warrior = { id: 'u1', templateId: 'warrior_id', name: 'Warrior', hasActed: false, currentSpirit: 100, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, currentShield: 0, maxSpirit: 100, spiritGain: 10, specialAbilityValue: 20, specialAbilityTarget: 'SINGLE_ENEMY' as const };
            const monster = { id: 'm1', templateId: 'goblin', name: 'Goblin', currentHealth: 50, maxHealth: 50, isDead: false, isPlayer: false, maxShield: 0, currentShield: 0, currentSpirit: 0, maxSpirit: 100, hasActed: false, spiritGain: 10 };
        ...
        it('should deal AOE damage', () => {
            const mage = { id: 'u1', templateId: 'aoe_dmg_id', name: 'Mage', hasActed: false, currentSpirit: 100, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, currentShield: 0, maxSpirit: 100, spiritGain: 10, specialAbilityValue: 10, specialAbilityTarget: 'ALL_ENEMIES' as const };
