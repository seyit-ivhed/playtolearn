...
describe('Player Actions Slice', () => {
    ...
    describe('resolveSpecialAttack', () => {
        it('should deal single target damage', () => {
            const warrior = { id: 'u1', templateId: 'warrior_id', name: 'Warrior', hasActed: false, currentSpirit: 100, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, currentShield: 0, maxSpirit: 100, spiritGain: 10, specialAbilityValue: 20, specialAbilityTarget: 'SINGLE_ENEMY' as const, statusEffects: [] };
            const monster = { id: 'm1', templateId: 'goblin', name: 'Goblin', currentHealth: 50, maxHealth: 50, isDead: false, isPlayer: false, maxShield: 0, currentShield: 0, currentSpirit: 0, maxSpirit: 100, hasActed: false, spiritGain: 10, statusEffects: [] };
        ...
        it('should deal AOE damage', () => {
            const mage = { id: 'u1', templateId: 'aoe_dmg_id', name: 'Mage', hasActed: false, currentSpirit: 100, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, currentShield: 0, maxSpirit: 100, spiritGain: 10, specialAbilityValue: 10, specialAbilityTarget: 'ALL_ENEMIES' as const, statusEffects: [] };
            const m1 = { id: 'm1', templateId: 'g1', name: 'G1', currentHealth: 50, maxHealth: 50, isDead: false, isPlayer: false, maxShield: 0, currentShield: 0, currentSpirit: 0, maxSpirit: 100, hasActed: false, spiritGain: 10, statusEffects: [] };
            const m2 = { id: 'm2', templateId: 'g2', name: 'G2', currentHealth: 30, maxHealth: 30, isDead: false, isPlayer: false, maxShield: 0, currentShield: 0, currentSpirit: 0, maxSpirit: 100, hasActed: false, spiritGain: 10, statusEffects: [] };
        ...
        it('should apply AOE shield', () => {
            const guardian = { id: 'u1', templateId: 'guardian_id_revived', name: 'Guardian', hasActed: false, currentShield: 0, currentSpirit: 100, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, maxSpirit: 100, spiritGain: 10, specialAbilityValue: 15, specialAbilityTarget: 'ALL_ALLIES' as const, specialAbilityType: 'SHIELD' as const, statusEffects: [] };
            const ally = { id: 'u2', templateId: 'warrior_id', name: 'Ally', hasActed: false, currentShield: 10, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, currentSpirit: 0, maxSpirit: 100, spiritGain: 10, statusEffects: [] };
        ...
        it('should handle failure (drain spirit, end turn)', () => {
            const warrior = { id: 'u1', templateId: 'warrior_id', name: 'Warrior', hasActed: false, currentSpirit: 100, maxHealth: 100, currentHealth: 100, isDead: false, isPlayer: true, maxShield: 0, currentShield: 0, maxSpirit: 100, spiritGain: 10, statusEffects: [] };
